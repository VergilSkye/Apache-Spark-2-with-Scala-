...
object MovieSimilarities {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    val source = Source.fromFile("ml-100k/u.item")
  ...
  def main(args: Array[String]) {
    ...
    //joinedRatings.sortByKey().take(10).foreach(println)
    ...
    //uniqueJoinedRatings.sortByKey().takeSample(true, 200, 50L).foreach(println)
