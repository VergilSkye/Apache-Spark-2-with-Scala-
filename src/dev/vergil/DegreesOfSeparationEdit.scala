...
object DegreesOfSeparationEdit {
  ...
  type BFSData = (Array[Int], Int, Color)
  ...
  def createStartingRdd(sc: SparkContext): RDD[BFSNode] = {
    val inputFile = sc.textFile("in/Marvel-graph.txt")
    inputFile.map(e => convertToBFS(e, startCharacterID))
  }

  /** Converts a line of raw input into a BFSNode */
  def convertToBFS(line: String, startID: Int): BFSNode = {
