...
object LinearRegression {
  ...
  def main(args: Array[String]) {
    ...
    val trainingLines = sc.textFile("in/regression.txt")
    ...
    val testingLines = sc.textFile("in/regression.txt")
    ...
    // Now we will create our linear regression model LinearRegressionWithSGD
